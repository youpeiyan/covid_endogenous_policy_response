...
**************************************************************************************
**** Function of this file: 12 regression case/death groups for robustness checks ****
**************************************************************************************
...
foreach case in cc cs cn ///
				...
				ndc nds ndn ///
				cbs dbs {
foreach policy in soe sip {
gen `case'_`policy' = `case' * `policy'
gen `case'_day`policy' = `case' * day_`policy'
gen `case'_lday`policy' = `case' * lday_`policy'
}
}
*/
...
global case				cc cs cn cn1 ncc ncs ncn
...
// The following 6 groups are including death reports and their daily changes. However, we don't report them due to strong correlation of case and death reports. 
...
*** 10.Case + Death Group 4: county case & national case + new county case & national case
global savefolder $resultgroup/list10

global ncase_soe		cn_soe ncn_soe dn_soe ndn_soe
global ncase_sip		cn_sip ncn_sip dn_sip ndn_sip
global ncase_day_soe	cn_daysoe ncn_daysoe dn_daysoe ndn_daysoe
global ncase_lday_soe	cn_ldaysoe ncn_ldaysoe dn_ldaysoe ndn_ldaysoe
global ncase_day_sip	cn_daysip ncn_daysip dn_daysip ndn_daysip
global ncase_lday_sip	cn_ldaysip ncn_ldaysip dn_ldaysip ndn_ldaysip

global case				cc cn ncc ncn dc dn ndc ndn
global case_soe			cc_soe ncc_soe dc_soe ndc_soe
global case_sip			cc_sip ncc_sip dc_sip ndc_sip
global case_day_soe		cc_daysoe ncc_daysip dc_daysoe ndc_daysip
global case_lday_soe	cc_ldaysoe ncc_ldaysoe dc_ldaysoe ndc_ldaysoe
global case_day_sip		cc_daysip ncc_daysip dc_daysip ndc_daysip
global case_lday_sip	cc_ldaysip ncc_ldaysip dc_ldaysip ndc_ldaysip

do $path/endog_res_loop.do

/*
*** 11.Case + Death Group 5: state case & national case + new state case & national case
global savefolder $resultgroup/list11

global case				cs cn ncs ncn ds dn nds ndn
global case_soe			cs_soe ncs_soe ds_soe nds_soe
global case_sip			cs_sip ncs_sip ds_sip nds_sip
global case_day_soe		cs_daysoe ncs_daysip ds_daysoe nds_daysip
global case_lday_soe	cs_ldaysoe ncs_ldaysoe ds_ldaysoe nds_ldaysoe
global case_day_sip		cs_daysip ncs_daysip ds_daysip nds_daysip
global case_lday_sip	cs_ldaysip ncs_ldaysip ds_ldaysip nds_ldaysip

do $path/endog_res_loop.do
*/

*** 12.Case + Death Group 6: county case & state & national case + county case & state & national case
global savefolder $resultgroup/list12

global case				cc cs cn ncc ncs ncn dc ds dn ndc nds ndn
global case_soe			cc_soe ncc_soe cs_soe ncs_soe dc_soe ndc_soe ds_soe nds_soe
global case_sip			cc_sip ncc_sip cs_sip ncs_sip dc_sip ndc_sip ds_sip nds_sip
global case_day_soe		cc_daysoe ncc_daysip cs_daysoe ncs_daysip dc_daysoe ndc_daysip ds_daysoe nds_daysip
global case_lday_soe	cc_ldaysoe ncc_ldaysoe cs_ldaysoe ncs_ldaysoe dc_ldaysoe ndc_ldaysoe ds_ldaysoe nds_ldaysoe
global case_day_sip		cc_daysip ncc_daysip cs_daysip ncs_daysip dc_daysip ndc_daysip ds_daysip nds_daysip
global case_lday_sip	cc_ldaysip ncc_ldaysip cs_ldaysip ncs_ldaysip dc_ldaysip ndc_ldaysip ds_ldaysip nds_ldaysip
...
foreach policy in soe sip {
drop `case'_`policy'
drop `case'_day`policy'
drop `case'_lday`policy'
}
}
*/
